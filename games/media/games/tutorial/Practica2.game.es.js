...
undum.game.situations = {
    ...
    "atajo": new undum.SimpleSituation(
        ...
        Vaya, por el atajo que tomas hay una calle en obras y debes <a href='habitual'>volver al camino habitual</a>.</p>",
        {
    ...
    "memoria": new undum.SimpleSituation(
        ...
        <p>Crees haberlo comprado todo, así que <a href='terminar1'>vuelves a casa</a> contento por haber hecho el recado casi sin problemas. </p>",
        {
            ...
            enter: function(character, system, to){
              system.setQuality("ingredientes", 1);
            },
            displayOrder: 1,
            tags: ["topic"]
        }
    ...
    "whatsapp": new undum.SimpleSituation(
        "<p><img src='imagenes/whatsapp.jpg' width='500' height='320'></p>\
...
undum.game.qualities = {
    ...
    ingredientes: new undum.YesNoQuality("Ingredientes",{
        priority:"0001",
        group:'necesario',
        yesDisplay:"Sí",
        noDisplay:"No"})
...
undum.game.qualityGroups = {
    necesario: new undum.QualityGroup('Necesario', {priority:"0001"})
};
...
undum.game.init = function(character, system) {
    system.setCharacterText("<p>¿Lo tienes todo?</p>");
    character.qualities.mascarilla = 0;
    character.qualities.ingredientes = 0;
};
